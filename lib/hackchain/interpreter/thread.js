...
function Thread(memory, pc) {
  ...
  this.protectedMask = 0;
  this.protectedValue = -1;
}
module.exports = Thread;

Thread.prototype.setProtectedPage = function setProtectedPage(mask, value) {
  this.protectedMask = mask;
...
Thread.prototype.sw = function sw(word, a) {
  ...
  // Do not overwrite protected areas
  if ((addr & this.protectedMask) === this.protectedValue)
    return;
